...
for i, elemento in enumerate(twilight):
    twilight2.append((elemento + " " + str(i)))

print(list(twilight2))
...
[lista.split()[0] for lista in conquistadores]


primos_fermat = []
for i in range(10):
    fermat = 2**2**i + 1
    primos_fermat.append(fermat)

print(list(primos_fermat))
...
player = {key for key, val in major_league_players.items() if val >= 1980 and val <= 2015}
